...
const NavigationList = styled.ul`
  width: 100%;
  height: 90vh;
  background-color: rgb(236, 235, 235, 0.93);
  list-style: none;
  display: flex;
  gap: 5px;
  flex-direction: column;
...
const NavigationComponent = () => {
  ...
  const [hamburgerHasBeenOpened, setHamburgerHasBeenOpened] =
    useState(false);

  const [settingsIsOpen, setSettingsIsOpen] = useState(false);
  const [settingsHasBeenOpened, setSettingsHasBeenOpened] =
    useState(false);
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <NavigationItem>
          <NavigationLink to="/settings" className="buttonPop">
            Settings
          </NavigationLink>
        </NavigationItem>
        <NavigationItem>
      ...
      <SettingsListAnimated
        $settingsIsOpen={settingsIsOpen}
        $settingsHasBeenOpened={settingsHasBeenOpened}
      >
        <SettingsItem>
          <section>
            <strong>Connect XRPL Wallet.</strong>
            <TogglerButton />
          </section>
          <p>
            Sign XUMM 'sign-in' transaction to connect wallet,
            enabling on-chain document signing.
          </p>
        </SettingsItem>
        <SettingsItem>
          <section>
