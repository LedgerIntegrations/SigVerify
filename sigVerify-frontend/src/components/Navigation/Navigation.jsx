...
function Navigation() {
  ...
  return (
    <div id={styles.navContainer}>
      <div id={styles.leftSideNav}>
        <Link to="/" id={styles.navLogo}>
        ...
        <div id={styles.navLinks}>
          <div className={styles.linksBox}>
            ...
            <Link to="/upload" className='buttonPop' id={styles.uploadLink}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
            ...
            <Link to="/documents" className='buttonPop'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
            ...
            <Link to="/xrpl-ui" className='buttonPop'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
