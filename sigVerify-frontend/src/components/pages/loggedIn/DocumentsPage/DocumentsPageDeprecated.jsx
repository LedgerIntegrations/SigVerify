...
const DocumentFilterButton = styled.button`
    height: 100px;
    width: 200px;
    border-radius: 10px;
    border: none;
`;
const MainDocumentsSection = styled.div`
    display: flex;
    flex-wrap: wrap;
    gap: 20px;
    width: 100%;
...
const DocumentCategorySection = styled.section`
    width: 100%;
    min-width: 200px;
    height: 250px;
    background-color: #f0efefdf;
    padding: 20px 5vw;
    border-radius: 10px;
...
//                 <DocumentFilterButton className="buttonPop">Sent</DocumentFilterButton>
//                 <DocumentFilterButton className="buttonPop">Recieved</DocumentFilterButton>
//             </FilterButtonContainer> */}
...
//                         <ul>
//                             {documents.length === 0 ? (
//                                 <li>No documents found for this user.</li>
//                             ) : (
//                                 documents.map((item, index) => (
//                                     <li key={index}>
//                                         <em>{item.title}</em>
