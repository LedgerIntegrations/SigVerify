      ...
      <ProfilePage>
        <Block>
          <ProfileIntroWithWalletConnect>
            <ProfileWelcome
              membership={
                accountObject.membership.charAt(0).toUpperCase() +
                accountObject.membership.slice(1)
              }
            />
            {!accountObject.verifiedXrplWalletAddress && (
              <Warning>
                <p>
                  WARNING! - XRPL Wallet not connected for blockchain
                  signatures.
                </p>
                <button
                  className="buttonPop"
            ...
            <ProfileTierLimitsSection>
              ...
              <AccountTotalsSectionMainContent>
                ...
                <ContentStatSection>
                  ...
                  <em>
                    {accountObject.totalDocuments} /{' '}
                    {accountObject.documentLimit}
                  </em>
                </ContentStatSection>
                <ContentStatSection>
                  <h5>Blockchain Signatures:</h5>
                  {/* TODO: add max membership level signatures dynamically*/}
                  <em>{accountObject.totalSignatures} / 10</em>
                </ContentStatSection>
              </AccountTotalsSectionMainContent>
            </ProfileTierLimitsSection>
            <NavigationSlider
