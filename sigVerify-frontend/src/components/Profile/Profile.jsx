...
const OutterProfileContainer = styled.div`  
  display: flex;
...
const ProfileIntroStats = styled.div`
  width: 100%;
  display: flex;
  flex-wrap: wrap;
  justify-content: center;
...
const ProfileSubSection = styled.section`
  width: 95%;
  height: fit-content;
  display: flex;
  flex-direction: column;
...
const ProfileNavTiles = styled.div`
  display: grid;
...
const ProfileAccountTotalsSectionContainer = styled.div`
  width: 100%;
  display: flex;
  gap: 5px;
...
const ProfileAccountTotalsSection = styled.section`
  // width: fit-content;
  width: 50%;
  display: flex;
  flex-direction: column;
...
const AccountTotalsIconLink = styled(Link)`
  height: 16px;
  width: 16px;
    ...
    < >
      ...
      <OutterProfileContainer>
        <ProfileIntroStats>
          ...
          <ProfileSubSection>
            <ProfileAccountTotalsSectionContainer>
              <ProfileAccountTotalsSection>
                <div>
                  <h4>Documents</h4>
                  <AccountTotalsIconLink to="/documents">
                    {filledDocIcon}
                  </AccountTotalsIconLink>
                </div>
              ...
              <ProfileAccountTotalsSection>
                <div>
                  <h4>Signatures</h4>
                  <AccountTotalsIconLink to="/xrpl-ui">
                    {keySvg}
                  </AccountTotalsIconLink>
                </div>
                <AccountTotalsSectionMainContent>
